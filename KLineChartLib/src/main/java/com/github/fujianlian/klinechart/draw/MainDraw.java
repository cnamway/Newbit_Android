...
public class MainDraw implements IChartDraw<ICandle> {
    ...
    private void drawSelector(BaseKLineChartView view, Canvas canvas) {
        ...
        for (String s : strings) {
//            if (s.contains(mContext.getString(R.string.change_amount)) || s.contains(mContext.getString(R.string.change_range))) {
//                if (close >= 0) {
//                    mSelectorTextPaint.setColor(mContext.getResources().getColor(R.color.chart_green));
//                } else {
//                    mSelectorTextPaint.setColor(mContext.getResources().getColor(R.color.chart_red));
//                }
//            } else {
//                mSelectorTextPaint.setColor(mContext.getResources().getColor(R.color.chart_text));
//            }
