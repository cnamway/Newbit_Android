...
//        1充值，2提币，3转入，4转出，5资金交易-扣除，6资金交易-增加，7法币卖出，8法币买入，9.缴纳商家认证保证金，10退回商家认证保证金
        ...
        switch (item.getType()) {
            ...
            case 2:
                ...
                break;
            case 3:
                helper.setText(R.id.tvType, MyApplication.getApp().getString(R.string.str_assets_tran_in));
                type = 6;
                break;
            case 4:
                helper.setText(R.id.tvType, MyApplication.getApp().getString(R.string.str_assets_tran_out));
                type = 5;
                break;
            case 5:
                helper.setText(R.id.tvType, MyApplication.getApp().getString(R.string.str_trade_money_remove));
                type = 5;
                break;
            case 6:
