package com.spark.newbitrade.ui.lock;
...
public class LockPatternView extends View {
    ...
    private void init9Cells() {
        //the distance between the center of setCoinScale circles
    ...
    private void initPaints() {
        ...
        defaultPaint.setColor(Color.parseColor("#78d2f6"));
        defaultPaint.setStrokeWidth(2.0f);
        defaultPaint.setStyle(Style.STROKE);
        defaultPaint.setAntiAlias(true);

        selectPaint = new Paint();
        selectPaint.setColor(Color.parseColor("#00aaee"));
    ...
    /**
     * draw line not include circle (check whether the cell between setCoinScale cells )
     *
     * @param preCell
     * @param nextCell
     * @param canvas
    ...
    /**
     * get the cell between setCoinScale cells (it has the limitation: the pattern must be 3x3)
     *
    ...
    private Cell getCellBetweenTwoCells(Cell preCell, Cell nextCell) {
        //setCoinScale cells are in the same row
        ...
        //setCoinScale cells are in the same column
