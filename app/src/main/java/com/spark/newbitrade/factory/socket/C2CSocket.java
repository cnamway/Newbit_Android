 ...
 */
public class C2CSocket extends Thread implements ISocket {
    private static C2CSocket c2csocket = null;
    private static final String lock = "lockk";
    private static Socket socket = null;
    private static DataInputStream dis = null;
    private static DataOutputStream dos = null;
    private static SocketThread socketThread = null;
    private static final String TAG = "C2CSocket";
    ...
    public static byte[] buildRequest(CMD cmd, byte[] body) {
        ...
        try {
            ...
            LogUtils.e("头部信息cmd:" + cmd.getCode() + ",length:" + length + ",sequenceId:" + sequenceId + new String(body));
    ...
    public void dealResponse(final TCPCallback tcpCallback) throws IOException {
        ...
        LogUtils.e("返回cmd:" + code + ",length:" + length + ",sequenceId:" + sequenceId + ",responseCode:"
                + responseCode + ",sequenceId:" + requestId + ",str:" + str);
